...
- **Мета** — локальные рекорды, достижения, скины, онбординг (интерактивный или слайды по A/B), локализация EN/RU.
...
Подпись **release** — в англ. README, раздел [Release signing](README.md#release-signing). Чеклист публикации: [docs/RELEASE_CHECKLIST.md](docs/RELEASE_CHECKLIST.md), soft launch: [docs/SOFT_LAUNCH.md](docs/SOFT_LAUNCH.md).
...
| `scripts/check_strings_parity.sh` | Совпадение ключей EN/RU |
| `scripts/build_release.sh` | Экспорт APK по пути из `store-upload.dir` |
