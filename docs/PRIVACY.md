...
> ⚠️ Replace bracketed placeholders (`[CONTACT_EMAIL]`, `[DEVELOPER_NAME]`) before publishing to Google Play. This is a template.

## 1. Data we collect

TiltMerge is designed to collect **the minimum data necessary**:
...
Your best score, unlocked skins, and settings are stored **on your device only** (`user://save.json`). Uninstalling the App deletes this data.

## 3. Third-party services

The App may use the following third-party services, each with its own privacy policy:
...
*This is a template generated for the TiltMerge project. Replace all placeholders before release.*
