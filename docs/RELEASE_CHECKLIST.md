...
- Gameplay modes, onboarding, local saves, skins, achievements, localisation and local leaderboards are implemented.
...
5. Publish a privacy policy at a stable URL and complete Play Data safety from the actual SDKs enabled in the build.
...
- A physical Android test confirms no crash, working controls and valid restore/reinstall behaviour.
